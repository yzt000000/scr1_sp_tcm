...
//
// Filename    : DW_apb_uart_bcm06.v
// Revision    : $Id: //dwh/DW_ocb/DW_apb_uart/amba_dev/src/DW_apb_uart_bcm06.v#10 $
// Author      : Rick Kelly          04/14/04
// Description : DW_apb_uart_bcm06.v Verilog module for DWbb
//
// DesignWare IP ID: 17727bb0
//
////////////////////////////////////////////////////////////////////////////////

module i_uart_DW_apb_uart_bcm06 (
    clk,
    rst_n,
    init_n,
    push_req_n,
...
// SJ: The STARC-2.3.4.3 rule flags flip-flop descriptions that have neither asynchronous set nor asynchronous reset. These below flip-flops have asynchronous negedge reset 'rst_n'.
