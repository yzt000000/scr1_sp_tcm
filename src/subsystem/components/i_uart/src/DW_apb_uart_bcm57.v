...
//
// Filename    : DW_apb_uart_bcm57.v
// Revision    : $Id: //dwh/DW_ocb/DW_apb_uart/amba_dev/src/DW_apb_uart_bcm57.v#10 $
// Author      : Rick Kelly    April 26, 2004
// Description : DW_apb_uart_bcm57.v Verilog module for DWbb
//
// DesignWare IP ID: 2668b35f
//
////////////////////////////////////////////////////////////////////////////////



  module i_uart_DW_apb_uart_bcm57 (
        clk,
        rst_n,
        init_n,
        wr_n,
...
// SJ: The STARC-2.3.4.3 rule flags flip-flop descriptions that have neither asynchronous set nor asynchronous reset. The STARC-2.3.4.3 rule also flags set/reset signals that are tied to supply or ground pins. All flip-flops used in the design have initial set/reset pins for initializing the state of the design. If a flip-flop is not controllable from external pin, it would have an undefined value after initialization and may produce undesirable results. However, if the flip-flop is deliberately designed such that neither asynchronous set nor asynchronous reset exist, then this kind of warning could be suppressed.
