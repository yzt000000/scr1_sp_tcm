...
// Revision: $Id: //dwh/DW_ocb/DW_ahb/amba_dev/src/DW_ahb_cc_constants.v#16 $ 
--
...
`define NUM_IAHB_SLAVES 3


// Name:         NUM_NAHB_SLAVES
// Default:      3 (NUM_IAHB_SLAVES)
// Values:       0, ..., 31
...
//set to "Normal" or "Normal & Boot" and if you have an internal decoder (AHB_HAS_XDCDR = 0).
...
// 
`define R1_N_SA_2 32'h2000

//to "Normal" or "Normal & Boot" and if you have an internal decoder (AHB_HAS_XDCDR = 0).
...
`define AHB_VERSION_ID 32'h3231332a
