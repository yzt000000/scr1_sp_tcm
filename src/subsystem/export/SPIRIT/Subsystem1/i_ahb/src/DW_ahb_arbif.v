...
// Revision: $Id: //dwh/DW_ocb/DW_ahb/amba_dev/src/DW_ahb_arbif.v#8 $ 
--
-- File :                       DW_ahb_arbif.v
...
//
  ...
  assign maskmaster[2]  = (pl2[3:0] == 4'b0);

  assign bus_priority[3:0]   = 4'hf;
  assign bus_priority[7:4]   = ~pl1[3:0];
  assign bus_priority[11:8]  = ~pl2[3:0];
