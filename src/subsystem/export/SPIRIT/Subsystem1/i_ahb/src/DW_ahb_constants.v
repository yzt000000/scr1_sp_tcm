...
// Default:      3 (NUM_AHB_MASTERS+1)
// Values:       2, ..., 16
// 
// Internal Master PortCount
`define NUM_INT_MASTERS 3


// Name:         NUM_INT_SLAVES
// Default:      4 (NUM_IAHB_SLAVES+1)
// Values:       2, ..., 32
// 
// Internal Master PortCount
`define NUM_INT_SLAVES 4


// Name:         HRESPBUS_WIDTH
// Default:      8 (([<functionof> + work.DW_ahb_cc_constants.v.NUM_IAHB_SLAVES 1 
//               32])*2)
// Values:       2, ..., 64
// 
// Internal HTRANS Bus Width
`define HRESPBUS_WIDTH 8
...
// 
// Internal HTRANS Bus Width
`define HTRANSBUS_WIDTH 6


// Name:         HSIZEBUS_WIDTH
// Default:      9 (([<functionof> + work.DW_ahb_cc_constants.v.NUM_AHB_MASTERS 1 
//               32])*3)
// Values:       3, ..., 48
// 
// HSIZE Address Bus Width
`define HSIZEBUS_WIDTH 9
...
`define HBURSTBUS_WIDTH 9


// Name:         HPROTBUS_WIDTH
// Default:      12 (([<functionof> + work.DW_ahb_cc_constants.v.NUM_AHB_MASTERS 1 
//               32])*4)
// Values:       4, ..., 96
// 
// HPROT Address Bus Width
`define HPROTBUS_WIDTH 12


// Name:         HWRITEBUS_WIDTH
// Default:      3 ([<functionof> + work.DW_ahb_cc_constants.v.NUM_AHB_MASTERS 1 
//               32])
// Values:       1, ..., 16
// 
// HWRITE Address Bus Width
`define HWRITEBUS_WIDTH 3
...
// 
// HWRITE Address Bus Width
`define HREADY_WIDTH 4


// Name:         INTERNAL_HSEL
// Default:      5 (NUM_IAHB_SLAVES+2)
// Values:       -2147483648, ..., 2147483647
// 
// InternalBusWidth
`define INTERNAL_HSEL 5


// Name:         SPLITBUS_WIDTH
// Default:      48 (NUM_IAHB_SLAVES*16)
// Values:       -2147483648, ..., 2147483647
// 
// HWRITE Address Bus Width
`define SPLITBUS_WIDTH 48


// Name:         HSPLIT_BUSWIDTH
// Default:      9 (NUM_IAHB_SLAVES*NUM_INT_MASTERS)
// Values:       -2147483648, ..., 2147483647
// 
// HWRITE Address Bus Width
`define HSPLIT_BUSWIDTH 9
...
// Default:      64 (AHB_CCL_WIDTH*NUM_AHB_MASTERS)
// Values:       -2147483648, ..., 2147483647
// 
// Required bus width for icl bus.
`define AHB_CCL_BUS_WIDTH 64
